...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE data_dosen SET dosen_name = ?, jenis_kelamin = ?, tempat_tgl_lahir = ?, alamat = ?, no_hp = ?, email = ? WHERE dosen_id = ?";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssssi", $dosen_name, $jenis_kelamin, $tempat_tgl_lahir, $alamat, $no_hp, $email, $dosen_id);
...
<nav id="sidebar">
  ...
  <div class="edit-container">
    ...
    <form id="editForm" method="POST">
        ...
        <input type="text" name="dosen_name" required>
