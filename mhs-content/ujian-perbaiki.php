...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertQuery = "INSERT INTO ujian_perbaiki (mhs_id, mhs_name, matkul_id, matkul_name, dosen_id, dosen_name, tanggal, jam, ruang) 
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($insertQuery);
    $stmt->bind_param("sssssssss", $mhs_id, $mhs_name, $matkul_id, $matkul_name, $dosen_id, $dosen_name, $tanggal, $jam, $ruang);

    if ($stmt->execute()) {
      $success_message = "Pengajuan ujian perbaiki berhasil disimpan!";
  } else {
...
<head>
    ...
    <title>Form Pengajuan Ujian Susulan</title>
...
<nav id="sidebar">
      ...
      <li>
        ...
        <ul class="sub-menu">
          <div>
            ...
            <li class="active"><a href="ujian-perbaiki.php">Ujian Perbaikan (M)</a></li>
  ...
  <div class="sub-exam">
    <h2>Pengajuan Ujian Perbaikan</h2>
    <p class="description">Silakan isi form berikut untuk mengajukan ujian perbaikan.</p>
