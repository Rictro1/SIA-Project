...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE data_mhs SET mhs_name = ?, jenis_kelamin = ?, tempat_tgl_lahir = ?, alamat = ?, nama_ayah = ?, nama_ibu = ?, no_hp = ?, email = ? WHERE mhs_id = ?";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssssssi", $mhs_name, $jenis_kelamin, $tempat_tgl_lahir, $alamat, $nama_ayah, $nama_ibu, $no_hp, $email, $mhs_id);
...
<nav id="sidebar">
  ...
  <div class="edit-container">
    ...
    <form id="editForm" method="POST">
        ...
        <input type="text" name="mhs_name" required>
        ...
        <button class="btn"><a href="account.php?logout=true">Kembali</a></button>
    </form>
