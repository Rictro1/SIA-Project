...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insert = "INSERT INTO angket_institusi (mhs_id, mhs_name, aspek1, aspek2, aspek3, aspek4, aspek5, aspek6, aspek7, aspek8, aspek9, aspek10, aspek11, aspek12, aspek13, aspek14, aspek15, aspek16, aspek17, saran)
                VALUES ('$mhs_id', '$mhs_name', '$aspek[1]', '$aspek[2]', '$aspek[3]', '$aspek[4]', '$aspek[5]', '$aspek[6]', '$aspek[7]', '$aspek[8]', '$aspek[9]', '$aspek[10]', '$aspek[11]', '$aspek[12]', '$aspek[13]', '$aspek[14]', '$aspek[15]', '$aspek[16]', '$aspek[17]', '$saran')";
...
<nav id="sidebar">
      ...
      <li>
        ...
        <ul class="sub-menu">
          <div>
            ...
            <li class="active"><a href="angket-institusi.php">Angket Institusi</a></li>
          </div>
        </ul>
      </li>
      <li>
  ...
  <div class="angket-form">
    <h2 class="angket-form-title">Angket Institusi</h2>
    ...
    <form method="POST" class="angket-form-body">
        <table class="angket-table" border="1">
            ...
            <tbody>
                <?php
                    $aspek = [
                        "Kenyamanan ruang kuliah teori",
                        "Kenyamanan dan ketersediaan Laboratoriuum 1",
                        "Kenyamanan dan ketersediaan Laboratoriuum 2",
                        "Kenyamanan dan ketersediaan Laboratoriuum 3",
                        "Kelengkapan alat praktik untuk praktikum",
                        "Pelayanan bagian laboratorium(Asisten LAB dan Kepala LAB)",
                        "Pelayanan bagian perpustakaan",
                        "Jumlah dan mutu buku, diktat, jurnal, dll di perpustakaan",
                        "Pelayanan bagian keuangan",
                        "Pelayanan administrasi akademik",
                        "Pelayanan bimbingan akademik (Dosen penasihat akademik)",
                        "Pelayanan keamanan kampus (Satpam, parkir kendaraan, dll)",
                        "Kebersihan lingkungan kampus (Taman, kamar mandi, dll)",
                        "Kenyamanan dan ketersediaan sarana ibadah (musholla, tempat wudhu, dll)",
                        "Ketersediaan sarana olahraga (Lapangan, perlengkapan, dll)",
                        "Cakupan dan bandwidth hotspot (wifi) kampus",
                        "Pelayanan sistem informasi (website, pengumuman elektronik, dll)"
                    ];
        ...
        <p class="saran-label"><strong>Saran dan Pendapat :</strong></p>
