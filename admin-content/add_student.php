...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO data_mhs (mhs_id, mhs_name, jenis_kelamin, tempat_tgl_lahir, alamat, nama_ayah, nama_ibu, no_hp, email, program_studi, semester, kelas, password) 
            VALUES ('$mhs_id', '$mhs_name', '$jenis_kelamin', '$tempat_tgl_lahir', '$alamat', '$nama_ayah', '$nama_ibu', '$no_hp', '$email', '$program_studi', '$semester', '$kelas', '$password')";
...
<div class="container">
    ...
    <form method="POST" action="">
        <label for="mhs_id">ID Mahasiswa :</label>
        <input type="text" name="mhs_id" required><br>

        <label for="mhs_name">Nama :</label>
        <input type="text" name="mhs_name" required><br>
        ...
        <button type="submit" class="submit-button">Tambah Mahasiswa</button>
        <button  class="submit-button"><a href="edit_data.php?logout=true">Back</a></button>
    </form>
</div>
</body>
</html>
