...
$sql = "SELECT mhs_id, mhs_name,  aspek1, aspek2, aspek3, aspek4, aspek5, aspek6, aspek7, aspek8, aspek9, aspek10, aspek11, aspek12, aspek13, aspek14, aspek15, aspek16, aspek17, saran FROM angket_institusi";
...
<head>
    ...
    to {
        ...
        .angket-tabel tr:nth-child(even) {
        ...
        .angket-tabel tr:hover {
            background: rgba(255, 255, 255, 0.4);
            transform: scale(1.01);
        }

        .angket-tabel td:hover {
...
<nav id="sidebar">
  ...
  <main>
  <div class="dsn-list">
        <h2>Daftar Angket Institusi</h2>
        <h3>Keterangan :</h3>
        <p>SK : Sangat Kurang</p>
        <p>K   : Kurang</p>
        <p>C   : Cukup</p>
        <p>B   : Baik</p>
        <p>SB : Sangat Baik</p>
        <div class="angket-tabel">
            <table>
                <tr>
                    <th>Mahasiswa ID</th>
