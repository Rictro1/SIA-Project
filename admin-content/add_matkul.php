...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO matkul_list (matkul_id, matkul_name, dosen_id, sks, hari, pukul) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("isiiss", $matkul_id, $matkul_name, $dosen_id, $sks, $hari, $pukul);
    
    if ($stmt->execute()) {
        $success_message = "Mata Kuliah berhasil ditambahkan!";
    } else {
        $error_message = "Terjadi kesalahan saat menambahkan mata kuliah!";
    }
}
...
<nav id="sidebar">
    ...
    <div class="container">
        ...
        <form method="POST" action="add_matkul.php">
          <label for="matkul_id">ID Mata Kuliah</label>
          <input type="number" id="matkul_id" name="matkul_id" required>

          <label for="matkul_name">Nama Mata Kuliah</label>
          <input type="text" id="matkul_name" name="matkul_name" required>
          ...
          <button type="submit" class="submit-button">Tambah Mata Kuliah</button>
          <button  class="submit-button"><a href="matkul_list.php?logout=true">Back</a></button>
      </form>
    </div>
