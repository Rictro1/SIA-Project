...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE data_admin SET admin_name = ?, jenis_kelamin = ?, tempat_tgl_lahir = ?, alamat = ?, no_hp = ?, email = ? WHERE admin_id = ?";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssssi", $admin_name, $jenis_kelamin, $tempat_tgl_lahir, $alamat, $no_hp, $email, $admin_id);
